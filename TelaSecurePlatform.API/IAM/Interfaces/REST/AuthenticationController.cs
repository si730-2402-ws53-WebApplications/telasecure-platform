...
using TelaSecurePlatform.API.IAM.Infrastructure.Pipeline.Middleware.Attributes;
using TelaSecurePlatform.API.IAM.Interfaces.REST.Resources;
using TelaSecurePlatform.API.IAM.Interfaces.REST.Transform;

namespace TelaSecurePlatform.API.IAM.Interfaces.REST;
