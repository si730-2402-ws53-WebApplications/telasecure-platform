...
using TelaSecurePlatform.API.Profiles.Interfaces.REST.Resources;
using TelaSecurePlatform.API.Profiles.Interfaces.REST.Transform;

namespace TelaSecurePlatform.API.Profiles.Interfaces.REST;
