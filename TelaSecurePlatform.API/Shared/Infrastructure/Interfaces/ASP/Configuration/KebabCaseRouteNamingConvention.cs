...
using TelaSecurePlatform.API.Shared.Infrastructure.Interfaces.ASP.Configuration.Extensions;

namespace TelaSecurePlatform.API.Shared.Infrastructure.Interfaces.ASP.Configuration;
